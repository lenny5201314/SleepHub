...
(function ($, undefined) {
  ...
  Plyrist.prototype = {
    _el: {
      ...
      // 播放器css icon 位置
      controls: { 
        prev: '<button type="button" class="plyr__control" data-plyr="prev"><i class="fas fa-backward"></i><span class="plyr__tooltip" role="tooltip">上一首</span></button>',
        play: '<button type="button" class="plyr__control" aria-pressed="false" aria-label="Play, {title}" data-plyr="play"><i class="fas fa-pause icon--pressed"></i><i class="icon--not-pressed fas fa-play"></i><span class="label--pressed plyr__tooltip" role="tooltip">暫停</span><span class="label--not-pressed plyr__tooltip" role="tooltip">播放</span></button>',
        next: '<button type="button" class="plyr__control" data-plyr="next"><i class="fas fa-forward"></i><span class="plyr__tooltip" role="tooltip">下一首</span></button>',
        ...
        mute: '<button type="button" class="plyr__control" aria-pressed="false" aria-label="Mute" data-plyr="mute">   <i class="fas fa-volume-up icon--pressed"></i><use xlink:href="#plyr-muted"></use>   <i class="fas fa-volume-mute icon--not-pressed"></i><use xlink:href="#plyr-volume"></use>  <span class="label--pressed plyr__tooltip" role="tooltip">取消靜音</span><span class="label--not-pressed plyr__tooltip" role="tooltip">靜音</span></button>',
        ...
        like: '<button type="button" class="plyr__control" aria-pressed="false" data-plyr="like">  <i class="fas fa-heart icon--pressed"></i><use xlink:href="#plyr-liked"></use> <i class="far fa-heart icon--not-pressed"></i><use xlink:href="#plyr-like"></use>   <span class="label--pressed plyr__tooltip" role="tooltip">移除我的最愛</span><span class="label--not-pressed plyr__tooltip" role="tooltip">加入我的最愛</span></button>',
        shuffle: '<button type="button" class="plyr__control" data-plyr="shuffle" ><svg role="presentation"><use xlink:href="#plyr-shuffle"></use></svg><span class="plyr__tooltip" role="tooltip">隨機播放</span></button>',
        repeat: '<button type="button" class="plyr__control" data-plyr="repeat"><i class="fas fa-redo-alt"></i><use xlink:href="#plyr-repeat"></use> <span class="plyr__tooltip" role="tooltip">循環播放</span></button>',
        list: '<button type="button" class="plyr__control" data-plyr="list"><i class="fas fa-headphones-alt"></i><use xlink:href="#plyr-list"></use><span class="plyr__tooltip" role="tooltip">播放清單</span></button>'
      }
    },
    ...
    _options: {
      theme: 0,
      iconUrl: '/static/libs/plyrist/src/plyrist.svg',
      autoplay: true,
      hideControls: false,
